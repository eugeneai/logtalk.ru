...
% ВАША РЕАЛИЗАЦИЯ ПРОТОКОЛА ЗДЕСЬ
...
% ВАША РЕАЛИЗАЦИЯ ОБЪЕКТОВ ЗДЕСЬ
:- object(circle(_Radius_)).
   % РЕАЛИЗУЙТЕ МЕТОДЫ area/1 И perimeter/1
:- end_object.
...
% ВАША РЕАЛИЗАЦИЯ КВАДРАТА ЗДЕСЬ
:- object(square(_Side_)).
   % УНАСЛЕДУЙТЕ ОТ rectangle С ПРАВИЛЬНЫМИ ПАРАМЕТРАМИ
:- end_object.
...
% - Должны быть методы для добавления фигур: add_circle/1, add_rectangle/2, add_square/1
% - Методы area/1 и perimeter/1 должны вычислять СУММЫ по всем фигурам
% - Используйте динамические предикаты для хранения фигур
% - Используйте findall/3 для агрегации результатов
%
% ПЛАН РЕШЕНИЯ:
% 1. Объявите private dynamic предикаты для хранения фигур
% 2. Реализуйте методы добавления фигур (assertz)
...
% ВАША РЕАЛИЗАЦИЯ КОЛЛЕКЦИИ ФИГУР ЗДЕСЬ
:- object(figures).
   % ОБЪЯВИТЕ ДИНАМИЧЕСКИЕ ПРЕДИКАТЫ ДЛЯ ХРАНЕНИЯ ФИГУР
   % РЕАЛИЗУЙТЕ МЕТОДЫ ДОБАВЛЕНИЯ ФИГУР
   % РЕАЛИЗУЙТЕ area/1 И perimeter/1 ДЛЯ ВСЕЙ КОЛЛЕКЦИИ
:- end_object.
...
% ВАША РЕАЛИЗАЦИЯ АВТОМАТА ЗДЕСЬ
:- object(automaton(_InitialState_)).
   % ОБЪЯВИТЕ protected q/4
   % РЕАЛИЗУЙТЕ model/3 И model/4
:- end_object.
...
% ВАША РЕАЛИЗАЦИЯ АВТОМАТА ДЛЯ ЧИСЕЛ ЗДЕСЬ
:- object(float_automaton(_Initial_)).
   % УНАСЛЕДУЙТЕ ОТ automaton
   % РЕАЛИЗУЙТЕ q/4 СО ВСЕМИ НЕОБХОДИМЫМИ ПЕРЕХОДАМИ
:- end_object.
...
% ВАША РЕАЛИЗАЦИЯ ГЕНЕРАТОРА ЗДЕСЬ
:- object(float_generator(_Initial_)).
   % УНАСЛЕДУЙТЕ ОТ float_automaton
   % РЕАЛИЗУЙТЕ generate/1 И generate_valid/1
:- end_object.
...
% ВАША РЕАЛИЗАЦИЯ АРИФМЕТИЧЕСКОГО АВТОМАТА ЗДЕСЬ
:- object(arithmetic_automaton(_Initial_)).
   % УНАСЛЕДУЙТЕ ОТ automaton
   % РЕАЛИЗУЙТЕ q/4 ДЛЯ АРИФМЕТИЧЕСКИХ ВЫРАЖЕНИЙ
   % РЕАЛИЗУЙТЕ evaluate/2 С ВЫЧИСЛЕНИЕМ РЕЗУЛЬТАТА
:- end_object.
...
% ВАША РЕАЛИЗАЦИЯ ПАРСЕРА ЗДЕСЬ
:- object(parser(_Lexic_)).
   % ОБЪЯВИТЕ protected ПРЕДИКАТЫ ДЛЯ КАЖДОГО ПРАВИЛА ГРАММАТИКИ
   % РЕАЛИЗУЙТЕ parse/2 И ВСПОМОГАТЕЛЬНЫЕ ПРЕДИКАТЫ
:- end_object.
...
% ВАША РЕАЛИЗАЦИЯ ЛЕКСИКОНА ЗДЕСЬ
:- object(gen_lexic).
   % ОПРЕДЕЛИТЕ determinant/1, noun/1, verb/1
:- end_object.

:- object(cow_lexic).
   % УНАСЛЕДУЙТЕ ОТ gen_lexic И ДОБАВЬТЕ СУЩЕСТВИТЕЛЬНЫЕ И ГЛАГОЛЫ
:- end_object.
...
% ВАША РЕАЛИЗАЦИЯ ГЕНЕРАТОРА ПРЕДЛОЖЕНИЙ ЗДЕСЬ
:- object(cow_lang).
   % УНАСЛЕДУЙТЕ ОТ parser(cow_lexic)
   % РЕАЛИЗУЙТЕ generate/1
:- end_object.
...
% ВАША РЕАЛИЗАЦИЯ БАЛАНСИРОВЩИКА ДЕРЕВЬЕВ ЗДЕСЬ
:- object(tree_balancer).
   % РЕАЛИЗУЙТЕ balance/2, is_balanced/1, height/2
   % И ВСПОМОГАТЕЛЬНЫЕ ПРЕДИКАТЫ
:- end_object.
