...
% Запускать:
%
% ?- test_alg(depth_first(labyrinth))::run.
%
...
% -----------------------------------------------------
% Упражнение 16: Реализация эвристического алгоритма поиска
% в глубину с последовательным погружением IDA*. Отличие
% от ID (Iterative Deeping) в том, что ограничением по глубине
% выступает не максимальное кол-во шагов или длина пройденного
% пути, а значение G+H, т.е. пройденный путь со значением
